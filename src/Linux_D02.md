...
>
> ![Вывод команды ip a ws1](screen%2Fscreen_2_03.png)
>
...
>
> ![Вывод команды ip a ws2](screen%2Fscreen_2_02.png)
>
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws1)](screen%2Fscreen_2_04.png)
>

```yaml
network: # Основной раздел, который описывает конфигурацию сети
  ethernets: # Раздел, в котором перечислены сетевые интерфейсы
    enp0s3: # Название сетевого интерфейса
      dhcp4: false # Отключение DHCP для данного интерфейса (статическая настройка IP).
      addresses: [192.168.100.10/16] # Статический IP-адрес для интерфейса enp0s3 с маской сети /16 (255.255.0.0).
...
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws2)](screen%2Fscreen_2_05.png)
>
...
>
> ![Применение настроек сети (ws1)](screen%2Fscreen_2_06.png)
>

> Применение настроек сети (ws2)
>
> ![Применение настроек сети (ws2)](screen%2Fscreen_2_07.png)
>

**2.1. Добавление статического маршрута вручную:**

*Чтобы настроить маршрут между двумя виртуальными машинами и обеспечить их связь через пинг, нужно изменить тип подключения на "внутреннюю сеть". Это обеспечит прямое соединение между виртуальными машинами без выхода в интернет.*

- Открыл интерфейс **Virtual Box**.
- Зашел в настройки сети машины **ws1**, и изменил тип подключения на **внутреннюю сеть**.

> Изменение типа подключения в VB ws1:
>
> ![Изменение типа подключения в VB ws1:(1)](screen%2Fscreen_2_08.png)
> ![Изменение типа подключения в VB ws1:(2)](screen%2Fscreen_2_09.png)
> ![Изменение типа подключения в VB ws1:(3)](screen%2Fscreen_2_10.png)
> 

- То же самое сделал для второй машины **ws2**.

> Изменение типа подключения в VB ws2
>
> ![Изменение типа подключения в VB ws2](screen%2Fscreen_2_11.png)
>
...
>
> ![Добавляем статический маршрут от ws1 до ws2](screen%2Fscreen_2_12.png)
>
...
>
> ![Добавляем статический маршрут от ws2 до ws1](screen%2Fscreen_2_13.png)
>
...
>
> ![Успешно пропингованный ip 172.24.116.8](screen%2Fscreen_2_14.png)
>
...
>
> ![Успешно пропингованный ip 192.168.100.10](screen%2Fscreen_2_15.png)
>
...
> Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws1)
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws1)](screen%2Fscreen_2_16.png)
>
...
> Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws2)
>
> ![Измененный файл конфигурации /etc/netplan/00-installer-config.yaml (ws2)](screen%2Fscreen_2_17.png)
>
...
network: # Основной раздел, который описывает конфигурацию сети
  ethernets: # Раздел, в котором перечислены сетевые интерфейсы
    enp0s3: # Название сетевого интерфейса
      dhcp4: false # Отключение DHCP для данного интерфейса (статическая настройка IP).
      addresses: [172.24.116.8/12] # Статический IP-адрес для интерфейса enp0s3 с маской сети /16 (255.255.0.0).
...
> Успешно пропингованный ip 172.24.116.8
>
> ![Успешно пропингованный ip 172.24.116.8](screen%2Fscreen_2_18.png)
>
...
> Успешно пропингованный ip 192.168.100.10
>
> ![Успешно пропингованный ip 192.168.100.10](screen%2Fscreen_2_19.png)
>
